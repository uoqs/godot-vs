...
In this setup, Godot Engine is built from the source. Properties of the Visual Studio project generated by SCons are edited to keep configurations `editor` and `target_release` in a single project file. By default, the project file must be regenerated to change the configuration.
