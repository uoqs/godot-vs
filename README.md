...
In this setup properties of the engine project generated by SCons are edited to keep `editor` and `target_release` configurations in a single project file. By default, the project file must be regenerated to change the configuration.
